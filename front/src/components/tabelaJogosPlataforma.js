...
const TabelaJogosPlataforma = () => {
  ...
  const renderRows = () => {
    ...
    const currentRows = dadosFiltrados?.slice(indexOfFirstRow, ultimeIndice);
      ...
      <div className="pagination">
        {numeroPaginas.map((numero) => (
          <button
            ...
            className={`page-link ${paginaAtual === numero ? 'active' : ''}`}
          >
            {numero}
          </button>
        ))}
...
export default TabelaJogosPlataforma;
